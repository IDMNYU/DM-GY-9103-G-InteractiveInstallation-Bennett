...
•	Fab Lab Induction and Tandon Maker space Induction
...
•	Some sort of collection presentation system. Not Dropbox, GoogleDrive, etc. This system must not only store, but to present the media, writings and materials. Think: Blog, Evernote, Murl.ly, Pinterest, etc. Share the urls with me.

•	USB or wireless WebCamera

•	possibly a kinect (More information forthcoming)
...
• Consult the [Slack](https://iisp17.slack.com) channel 3 times a week for information and updates
